...
__all__ = [
    'DISPID_SPIGrammarId', 'eLEXTYPE_PRIVATE10', 'ISpEventSink',
    'ISpDataKey', 'DISPID_SWFEBitsPerSample', 'SVSFPersistXML',
    'ISpeechTextSelectionInformation', 'DISPID_SGRSTsCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIAudioSizeTime',
    'eLEXTYPE_PRIVATE7', 'SpeechVoiceEvents', 'SPSEMANTICFORMAT',
    'DISPID_SRRSpeakAudio', 'ISpeechDataKey',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPPS_Function', 'SWTDeleted',
    'SPWORDPRONUNCIATION', 'DISPID_SASState',
    'DISPID_SVGetAudioInputs', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpStreamFormatConverter', 'SpeechVisemeType',
    'eLEXTYPE_PRIVATE4', 'ISpeechAudioFormat', 'SECLowConfidence',
    'DISPID_SRGCmdLoadFromObject', 'SDTReplacement',
    'SVEEndInputStream', 'SPPS_RESERVED1', 'SRAInterpreter',
    'DISPID_SGRs_NewEnum', 'DISPID_SLPType', 'SPADAPTATIONRELEVANCE',
    'SpeechInterference', 'DISPID_SABufferNotifySize',
    'DISPID_SGRSTPropertyName', 'SPCT_SLEEP',
    'DISPID_SRCEFalseRecognition', 'SpeechCategoryRecoProfiles',
    'STCRemoteServer', 'DISPID_SGRSTsItem', 'SVP_13', 'SPAS_RUN',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SpeechAudioFormat',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRGCmdLoadFromResource', 'IInternetSecurityMgrSite',
    'SP_VISEME_15', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SMSGetData',
    'DISPID_SRCRequestedUIType', 'SAFTADPCM_11kHzMono',
    'DISPID_SVEViseme', 'ISpNotifySink', 'ISpeechAudioStatus',
    'SPCT_SUB_COMMAND', 'SPCS_ENABLED', 'SPPARTOFSPEECH',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SVVoice',
    'DISPID_SPEsItem', 'SSFMCreateForWrite', 'SAFTDefault',
    'SPCS_DISABLED', 'SPSMF_UPS', '_RemotableHandle', 'SRAExport',
    'DISPID_SRRecognizer', 'DISPID_SRGId', 'DISPID_SOTSetId',
    'STSF_FlagCreate', 'DISPID_SPAStartElementInResult',
    'DISPID_SBSRead', 'SPEI_MAX_TTS', 'Speech_StreamPos_Asap',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRGSetTextSelection',
    'DISPID_SPRs_NewEnum', 'DISPID_SOTCategory', 'ISpeechPhraseRule',
    'STSF_LocalAppData', 'IInternetSecurityManager',
    'SPEI_HYPOTHESIS', 'eLEXTYPE_RESERVED9',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTransitions',
    'ISpeechPhraseElement', 'SPEVENTSOURCEINFO',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SGSExclusive',
    'DISPID_SPEDisplayText', 'SRTReSent', 'SP_VISEME_16',
    'ISpeechPhraseRules', 'SpeechDisplayAttributes',
    'SpeechTokenIdUserLexicon', 'SpeechCategoryVoices',
    'DISPID_SWFEChannels', 'SpeechDiscardType',
    'DISPID_SPIAudioStreamPosition', 'SpeechDataKeyLocation',
    'SVF_None', 'DISPID_SVSCurrentStreamNumber',
    'SGLexicalNoSpecialChars', 'DISPID_SOTsCount', 'SAFT8kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpTextSelectionInformation',
    'DISPID_SVEEnginePrivate', 'DISPID_SPRulesCount', 'DISPID_SOTId',
    'SpeechWordPronounceable', 'SpeechCategoryAudioIn',
    'SpeechFormatType', 'SP_VISEME_4', 'SPEI_INTERFERENCE',
    'LONG_PTR', 'DISPID_SRGCmdSetRuleState', 'SP_VISEME_17',
    'SPPS_RESERVED2', 'SDTAudio', 'SAFTCCITT_ALaw_11kHzMono',
    'SVESentenceBoundary', 'SpeechUserTraining', 'ISpeechRecoGrammar',
    'ISpeechRecognizer', 'SPFM_OPEN_READWRITE', 'ISpeechLexiconWords',
    'DISPID_SADefaultFormat', 'ISpGrammarBuilder', 'SPRS_INACTIVE',
    'ISpRecoContext2', 'SPWT_LEXICAL', 'SPEI_RECO_OTHER_CONTEXT',
    'SPAO_NONE', 'SpeechTokenShellFolder', 'DISPID_SRSAudioStatus',
    'SPVPRI_OVER', 'SpNullPhoneConverter', 'SAFT24kHz16BitStereo',
    'DISPID_SPIProperties', 'DISPID_SLGetPronunciations', 'SVP_1',
    'SAFT32kHz8BitMono', 'DISPID_SPRsCount', 'SECNormalConfidence',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_RESERVED5',
    'SpSharedRecoContext', 'DISPID_SPEEngineConfidence',
    'DISPID_SABIEventBias', 'DISPID_SRGDictationSetState',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPAsItem', 'SPRST_ACTIVE_ALWAYS',
    'SVEStartInputStream', 'SDTPronunciation', 'SAFT44kHz16BitMono',
    'SpeechRecognizerState', 'DISPID_SVSRunningState',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVPriority',
    'SAFT48kHz16BitStereo', 'DISPID_SPRulesItem', 'SPEI_PHONEME',
    'SpeechSpecialTransitionType', 'SRCS_Enabled', 'DISPID_SLWWord',
    'ISpRecoContext', 'SPPS_Verb', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE3', 'SINoSignal',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_RECO_STATE_CHANGE',
    'SPAR_High', 'SPEI_WORD_BOUNDARY', 'DISPID_SGRAddResource',
    'DISPID_SRCEEndStream', 'DISPID_SOTRemove',
    'DISPID_SPEAudioTimeOffset', 'SRSActiveAlways',
    'DISPID_SAFGetWaveFormatEx', 'SREAdaptation', 'tagSPPROPERTYINFO',
    'SAFT32kHz16BitStereo', 'ISpeechVoice',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SLGetGenerationChange', 'SAFTGSM610_8kHzMono',
    'DISPID_SVWaitUntilDone', 'SPTEXTSELECTIONINFO',
    'ISpeechPhraseProperty', 'SRERecoOtherContext', 'SDTAll',
    'SAFT22kHz8BitStereo', 'DISPID_SGRSTNextState',
    'SECFNoSpecialChars', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVGetAudioOutputs', 'SGDisplay', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechPhraseReplacement', 'SpInprocRecognizer',
    'DISPID_SpeechBaseStream', 'DISPID_SGRSTType',
    'DISPID_SVEStreamStart', 'eLEXTYPE_PRIVATE17',
    'DISPIDSPTSI_ActiveLength', 'ISpPhoneConverter',
    'SAFT11kHz16BitStereo', 'SpeechWordType',
    'DISPID_SRCERecognition', 'DISPID_SVRate',
    'DISPID_SABIBufferSize', 'SDKLLocalMachine',
    'DISPID_SpeechRecoContext', 'SPAUDIOOPTIONS',
    ...
    'SAFT16kHz8BitMono', 'SAFT22kHz16BitMono', 'ISpeechRecoResult',
    'SpeechRegistryUserRoot', 'DISPID_SOTDataKey', 'SPEI_SR_BOOKMARK',
    'SDA_Consume_Leading_Spaces',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_18',
    'SpeechStreamSeekPositionType', 'SpeechVoicePriority',
    'SGRSTTTextBuffer', 'SPEI_UNDEFINED', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SLRemovePronunciation', 'SpMemoryStream',
    'DISPID_SOTCDefault', 'ISpeechPhraseReplacements',
    'DISPID_SBSFormat', 'DISPID_SRCESoundStart', 'DISPID_SVSpeak',
    'DISPID_SCSBaseStream', 'DISPID_SLPLangId', 'SPEI_MIN_TTS',
    'SPAS_STOP', 'DISPID_SVGetProfiles', 'SPEI_SR_RETAINEDAUDIO',
    'SPCT_SUB_DICTATION', 'SPAUDIOBUFFERINFO',
    ...
    'DISPID_SAFGuid', 'SpResourceManager', 'SVSFNLPMask',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIEngineId',
    'DISPID_SVEWord', 'DISPID_SPEAudioSizeTime', 'SPEI_RESERVED2',
    'SPGRAMMARWORDTYPE', 'ISpeechRecoResult2',
    'SpeechGrammarTagWildcard', 'SPBO_TIME_UNITS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPLO_STATIC', 'SPSInterjection',
    'SpeechCategoryPhoneConverters', 'DISPID_SGRSTPropertyValue',
    'SpSharedRecognizer', 'DISPID_SRCPause',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVSLastResult',
    'SAFT44kHz8BitMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SDKDeleteKey', 'DISPID_SLPSymbolic', 'SASClosed',
    ...
    'SP_VISEME_20', 'SpeechRunState', 'DISPID_SGRAddState',
    'DISPID_SRGetRecognizers', 'DISPID_SOTDisplayUI',
    'SPINTERFERENCE_TOOLOUD', 'SVSFNLPSpeakPunc',
    'SAFT8kHz8BitStereo', 'DISPID_SBSSeek', 'SPPHRASEPROPERTY',
    'ISpPhoneticAlphabetSelection', 'DISPID_SLWType', 'SPWT_DISPLAY',
    'SRCS_Disabled', 'SPWAVEFORMATTYPE', 'SpeechAudioState',
    'DISPID_SPRNumberOfElements', 'DISPID_SPIReplacements',
    'SPSUnknown', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREHypothesis', 'SPSNoun', 'DISPID_SVPause', 'SPAO_RETAIN_AUDIO',
    'SPDATAKEYLOCATION', 'SPPS_RESERVED3',
    'DISPID_SVSpeakCompleteEvent', 'SVP_4', 'SAFT12kHz16BitStereo',
    'SREStateChange', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechVoiceStatus', 'SpeechVoiceSkipTypeSentence',
    'SPSERIALIZEDPHRASE', 'SPPS_SuppressWord', 'SPWT_PRONUNCIATION',
    ...
    'SpeechAudioProperties', 'DISPID_SPIRule', 'DISPID_SBSWrite',
    'SPAS_CLOSED', 'SAFTCCITT_uLaw_22kHzStereo', 'SPBO_AHEAD',
    'ISpeechFileStream', 'SPAUDIOSTATE', 'DISPID_SPACommit',
    'SpeechTokenKeyFiles', 'DISPID_SPRuleChildren', 'DISPID_SRGReset',
    'SVP_19', 'DISPID_SVStatus', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPAsCount', 'SAFTText', 'SPRULE',
    'DISPID_SPRules_NewEnum', 'DISPID_SRState', 'SREAudioLevel',
    'SVEWordBoundary', 'SP_VISEME_21', 'SpCompressedLexicon',
    'DISPID_SRCEInterference', 'DISPID_SPPsCount',
    'DISPID_SpeechAudioBufferInfo', 'SpeechAllElements',
    'DISPID_SWFEExtraData', 'DISPID_SDKGetBinaryValue', 'SINoise',
    'SPWF_INPUT', 'DISPID_SGRInitialState', 'SRSInactiveWithPurge',
    'SPPS_Interjection', 'SpeechRetainedAudioOptions',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'WAVEFORMATEX', 'SSFMCreate',
    'DISPID_SGRSAddWordTransition', 'DISPID_SDKGetStringValue',
    'DISPID_SOTGetAttribute',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPRuleName', 'SpeechStreamFileMode',
    'DISPID_SPRuleConfidence', 'DISPID_SMSAMMHandle',
    'SPCATEGORYTYPE', 'SPXRO_Alternates_SML', 'SBONone',
    'SPEI_START_SR_STREAM', 'SPLO_DYNAMIC', 'SVF_Emphasis',
    'SWPKnownWordPronounceable', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSInputSentenceLength', 'SRTExtendableParse',
    'SGRSTTWord', 'SVP_5', 'SPCT_COMMAND', 'SVP_15',
    'SDKLCurrentUser', 'DISPID_SpeechRecoResultTimes',
    'SAFT24kHz16BitMono', 'DISPID_SPIStartTime',
    'DISPID_SpeechMMSysAudio', 'SITooQuiet',
    'DISPID_SpeechRecoResult', 'DISPID_SRRAlternates',
    'SpeechPropertyLowConfidenceThreshold', 'SPINTERFERENCE',
    'SPSEMANTICERRORINFO', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPXMLRESULTOPTIONS', 'DISPID_SRRTOffsetFromStart',
    'SPPROPERTYINFO', 'SPRECOSTATE', 'SRAImport',
    'SAFT8kHz16BitStereo', 'SPINTERFERENCE_NOSIGNAL', 'SLODynamic',
    'SpeechTokenValueCLSID', 'SAFTADPCM_8kHzMono', 'eLEXTYPE_APP',
    'SVEPhoneme', 'SPBOOKMARKOPTIONS',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_7',
    'SECHighConfidence', 'DISPID_SRIsUISupported',
    ...
    'DISPID_SPEPronunciation', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRCBookmark', 'SDKLCurrentConfig',
    'DISPID_SPEAudioStreamOffset', 'SAFT22kHz8BitMono', 'SVSFIsXML',
    'SAFTCCITT_ALaw_44kHzMono', 'SPRST_ACTIVE', 'DISPID_SRIsShared',
    'DISPID_SRCERequestUI', 'SpCustomStream',
    'ISpObjectTokenCategory', 'SPPHRASEELEMENT',
    'DISPID_SRRGetXMLResult', 'SREAllEvents',
    'DISPID_SpeechPhraseElements', 'SREPropertyNumChange',
    'SAFTADPCM_44kHzStereo', 'Speech_Max_Pron_Length',
    'DISPID_SPRuleParent', 'SPEI_RECOGNITION', 'DISPID_SRGRules',
    'SPSLMA', 'DISPID_SPAs_NewEnum', 'DISPID_SVResume',
    'DISPID_SPRText', 'SSTTTextBuffer', 'DISPID_SpeechRecognizer',
    'SPSHORTCUTPAIR', 'DISPID_SRRDiscardResultInfo',
    'ISpeechPhraseAlternates', 'SSSPTRelativeToCurrentPosition',
    'SPBO_PAUSE', 'SVPNormal', 'DISPID_SRGState',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechPhraseRule',
    'DISPID_SRCVoice', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SPCLangId',
    'DISPID_SDKEnumKeys', 'SSFMOpenForRead', 'DISPID_SOTCSetId',
    'DISPID_SpeechObjectToken', 'SGPronounciation',
    ...
    'eLEXTYPE_PRIVATE12', 'SPVOICESTATUS',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRCRecognizer', 'SDTRule',
    'DISPID_SABIMinNotification', 'DISPID_SGRSTText',
    'SAFT11kHz8BitStereo', 'ISpProperties',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPISaveToMemory', 'SVP_10', 'DISPID_SPRFirstElement',
    'DISPID_SRCEPhraseStart', 'DISPID_SAVolume', 'DISPID_SRRTLength',
    'DISPID_SGRAttributes', 'SPEI_SOUND_END', 'ISpeechRecoContext',
    'SPPS_NotOverriden', 'SpStream', 'DISPID_SVSInputWordLength',
    'SSSPTRelativeToEnd', 'DISPID_SpeechAudio', 'SP_VISEME_5',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLAddPronunciation',
    'DISPID_SPPFirstElement', 'SDA_No_Trailing_Space', 'ISpVoice',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE1',
    'SP_VISEME_10', 'DISPID_SRCRetainedAudio',
    'ISpeechRecoResultTimes', 'SREInterference',
    'SAFTGSM610_22kHzMono', 'SPEI_END_SR_STREAM', 'SPVISEMES',
    'SPGS_EXCLUSIVE', 'DISPID_SpeechLexiconWord', 'SGSDisabled',
    'SVEAudioLevel', 'SVSFParseSsml', 'DISPID_SRGCommit',
    'SAFTExtendedAudioFormat', 'SAFT22kHz16BitStereo', 'SASPause',
    'ISpRecognizer3', 'SREStreamStart', 'SpWaveFormatEx',
    'DISPID_SRStatus', 'SpMMAudioEnum', 'STCInprocHandler',
    'ISpeechObjectTokens', 'SPSHT_NotOverriden',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpMMAudioOut',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPPId', 'SRESoundStart',
    'DISPID_SPCPhoneToId', 'DISPID_SPPsItem', 'SDTProperty',
    'SASStop', 'SVSFParseSapi', 'SVEAllEvents',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT12kHz16BitMono',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT44kHz16BitStereo',
    ...
    'SFTSREngine', 'ISpeechRecoResultDispatch',
    'DISPID_SRCEPropertyNumberChange', 'SVP_2', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_20',
    'SP_VISEME_13', 'SP_VISEME_9', 'SAFTNonStandardFormat',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRGetFormat',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTRemoveStorageFileName',
    'SpAudioFormat', 'STCLocalServer', 'SP_VISEME_12',
    'SPEI_VOICE_CHANGE', 'SPBINARYGRAMMAR', 'SpeechRecognitionType',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPs_NewEnum',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCEBookmark', 'SSSPTRelativeToStart', 'DISPID_SLWLangId',
    'DISPID_SVGetVoices', 'DISPID_SLPPhoneIds',
    'ISpPhoneticAlphabetConverter', 'SpeechGrammarTagDictation',
    'ISpeechGrammarRule', 'SSTTWildcard', 'ISpeechWaveFormatEx',
    ...
    'DISPID_SRCEAdaptation', 'SAFT24kHz8BitMono', 'SVP_17',
    'SREPrivate', 'DISPID_SpeechWaveFormatEx', 'SAFTADPCM_22kHzMono',
    'SPPHRASERULE', 'SpeechRecoEvents', 'SAFTADPCM_22kHzStereo',
    'SPDKL_CurrentUser', 'SPEI_TTS_BOOKMARK', 'SPDKL_LocalMachine',
    'DISPID_SPILanguageId', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRRRecoContext', 'SpeechTokenContext',
    'DISPID_SOTCreateInstance', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVAudioOutput', 'eWORDTYPE_DELETED', 'SPAUDIOSTATUS',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPPConfidence',
    'DISPID_SRRSetTextFeedback', 'SVPOver', 'SVSFVoiceMask',
    'SPSERIALIZEDRESULT', 'SASRun', 'SREBookmark',
    'SAFT11kHz16BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SLWPronunciations', 'SP_VISEME_1', 'SPSHT_EMAIL',
    'DISPID_SFSOpen', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'eWORDTYPE_ADDED', 'SPINTERFERENCE_NONE', 'ISpeechCustomStream',
    'DISPID_SpeechPhoneConverter', 'SAFT48kHz8BitStereo',
    'SPGS_ENABLED', 'DISPID_SVIsUISupported', 'SPSTREAMFORMATTYPE',
    'SGRSTTDictation', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRRTTickCount', 'STSF_CommonAppData',
    'SWPUnknownWordUnpronounceable', 'ISpStreamFormat',
    'DISPID_SRSetPropertyString', 'SVP_14', '__MIDL_IWinTypes_0009',
    'SPSHT_OTHER', 'SPVPRI_ALERT', 'DISPID_SGRName',
    'DISPID_SRAudioInputStream', 'DISPID_SRCEEnginePrivate',
    'SP_VISEME_6', 'ISpeechAudio', 'SPEI_RESERVED6',
    'SECFIgnoreWidth', 'SREStreamEnd', 'SPWORD', 'SVEVoiceChange',
    'DISPID_SOTMatchesAttributes', 'SRARoot', 'DISPID_SOTs_NewEnum',
    'SGLexical', 'DISPID_SDKGetlongValue', 'SVSFDefault',
    'eLEXTYPE_LETTERTOSOUND', 'SPINTERFERENCE_TOOSLOW', 'SINone',
    'DISPID_SpeechMemoryStream', 'SPVPRIORITY', 'ISpNotifyTranslator',
    'DISPID_SRGCmdLoadFromFile', 'SPRECOGNIZERSTATUS',
    'SPCT_DICTATION', 'STCInprocServer', 'SPEI_MAX_SR',
    'DISPID_SDKOpenKey', 'SRERequestUI', 'DISPID_SOTCId',
    '_ISpeechVoiceEvents', 'DISPID_SDKDeleteValue', 'SRESoundEnd',
    'DISPID_SPRuleFirstElement', 'SPSSuppressWord', 'SPCONTEXTSTATE',
    'SPRST_INACTIVE', 'SPVPRI_NORMAL', 'ISpeechMemoryStream',
    'eLEXTYPE_PRIVATE2', 'DISPID_SGRSAddRuleTransition',
    'SVSFUnusedFlags', 'ISpRecognizer2', 'eLEXTYPE_PRIVATE18',
    'ISpeechPhraseElements', 'SpeechBookmarkOptions',
    'SSFMOpenReadWrite', 'DISPID_SVSkip', 'DISPID_SVEStreamEnd',
    'SRAONone', 'DISPID_SpeechRecognizerStatus',
    'SpeechVisemeFeature', 'ISpStream', 'eLEXTYPE_PRIVATE13',
    'ISpeechRecognizerStatus', 'SP_VISEME_11', 'SVP_9',
    'SPSMF_SAPI_PROPERTIES', 'DISPIDSPTSI', 'SPDKL_DefaultLocation',
    'SGDSActiveUserDelimited', 'DISPID_SRCEventInterests',
    'DISPID_SRCCreateGrammar', 'SAFTCCITT_uLaw_22kHzMono',
    'SPFM_NUM_MODES', 'DISPID_SRRTStreamTime', 'DISPID_SGRId',
    'DISPID_SPIElements', 'SP_VISEME_3', 'SAFTADPCM_44kHzMono',
    'DISPID_SASNonBlockingIO', 'SSTTDictation', 'SLTUser',
    'SAFT24kHz8BitStereo', 'DISPID_SPPName',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechAudioFormatType',
    'ISpeechMMSysAudio', 'DISPID_SVESentenceBoundary',
    'SpeechAudioVolume', 'ISpeechLexiconPronunciation',
    'DISPID_SpeechLexiconProns', 'SPEI_END_INPUT_STREAM',
    'Speech_Default_Weight', 'DISPIDSPTSI_SelectionOffset',
    'IEnumSpObjectTokens', 'DISPID_SpeechPhraseElement', 'SPPHRASE',
    'SpeechPartOfSpeech', 'SPEI_REQUEST_UI',
    'ISpeechObjectTokenCategory', 'SPPHRASEREPLACEMENT',
    'DISPID_SRRPhraseInfo', 'SpeechRecoContextState',
    'ISpeechPhraseInfo', 'eLEXTYPE_MORPHOLOGY', 'eLEXTYPE_PRIVATE15',
    'SBOPause', 'SpFileStream', 'SPINTERFERENCE_NOISE',
    'DISPID_SAStatus', 'ISpeechPhraseReplacement',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechGrammarRule',
    'DISPID_SRDisplayUI', 'SAFT48kHz8BitMono', 'SGDSActive',
    'DISPID_SRCESoundEnd', 'SpeechEngineProperties',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRSEDone', 'ISpShortcut',
    'ISpeechLexiconWord', 'ISpObjectWithToken',
    'SAFTCCITT_ALaw_11kHzStereo', 'Speech_StreamPos_RealTime',
    'ISpRecoGrammar2', 'SDKLDefaultLocation',
    'DISPID_SRSSupportedLanguages', 'ISpRecognizer', 'ISpLexicon',
    'SLOStatic', 'SPFM_CREATE', 'DISPID_SLPsItem',
    'ISpSerializeState', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_RESERVED6', 'SVP_3', 'DISPID_SOTGetStorageFileName',
    'SGSEnabled', 'DISPID_SRProfile', 'SVP_8', 'ISpeechLexicon',
    'SRATopLevel', 'SpeechVoiceSpeakFlags', 'SP_VISEME_18',
    'SITooSlow', 'SPSNotOverriden', 'SpObjectToken',
    'SVSFParseAutodetect', 'DISPID_SVSLastBookmarkId', 'SPEI_VISEME',
    'SVP_21', 'DISPID_SRCSetAdaptationData', 'DISPID_SDKCreateKey',
    'SPPS_LMA', 'SLTApp', 'SPFILEMODE', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechLexiconWords', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechPhraseInfoBuilder', 'ISpeechPhraseProperties', 'SVPAlert',
    'ISpPhrase', 'SPEI_SOUND_START', 'SITooFast', 'SRSActive',
    'DISPID_SASetState', 'SVP_7', 'SPDKL_CurrentConfig',
    'DISPID_SGRsAdd', 'SVP_11', 'SPSHT_Unknown', 'SRADefaultToActive',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRSTWeight',
    'SFTInput', 'ISpeechXMLRecoResult', 'SpeechEngineConfidence',
    'ISpeechResourceLoader', 'ISpRecoResult',
    'SpeechPropertyAdaptationOn', 'DISPID_SPPValue',
    'DISPID_SRSCurrentStreamPosition', 'SVSFParseMask',
    'SpeechLexiconType', 'DISPID_SOTIsUISupported', 'DISPID_SPRsItem',
    'SpShortcut', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SGRsCommit', 'DISPID_SPRuleId', 'SPPS_Noncontent',
    'ISpAudio', 'SECFDefault', 'SPWORDTYPE',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPPChildren',
    'SpeechCategoryAudioOut', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechRecoResult2', 'SPWORDLIST', 'SpeechRuleState',
    'SPEI_RESERVED1', 'DISPID_SRGetPropertyNumber', 'SPPS_Modifier',
    'SVF_Stressed', 'DISPID_SVSLastBookmark',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLPs_NewEnum',
    'DISPID_SLPsCount', 'ISpPhraseAlt', 'DISPID_SPIGetText',
    ...
    'DISPID_SREmulateRecognition', 'SpeechAddRemoveWord',
    'ISpNotifySource', 'eLEXTYPE_RESERVED8', 'SRSInactive',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPCIdToPhone',
    'SpLexicon', 'SPLEXICONTYPE', 'SPWF_SRENGINE',
    'DISPID_SRGIsPronounceable', 'DISPID_SDKSetStringValue',
    'SPAS_PAUSE', 'SAFT32kHz16BitMono', 'eLEXTYPE_PRIVATE14',
    'SAFT16kHz16BitMono', 'SRERecognition', 'SPGRAMMARSTATE',
    'SpeechRecoProfileProperties', 'DISPID_SGRsDynamic',
    'SPEVENTENUM', 'SREPropertyStringChange',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SGRSTs_NewEnum', 'SDTLexicalForm', 'DISPID_SLWsCount',
    'SpeechCategoryAppLexicons', 'STCAll',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SMSSetData',
    'SAFTCCITT_uLaw_11kHzStereo', 'SECFIgnoreKanaType',
    'DISPID_SpeechLexicon', 'DISPID_SAEventHandle',
    'DISPID_SPPParent', 'SWTAdded', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCCmdMaxAlternates', 'SGRSTTEpsilon',
    ...
    'SDA_One_Trailing_Space', 'ISpeechPhoneConverter', 'DISPIDSPRG',
    'SpMMAudioIn', 'SAFT48kHz16BitMono', 'DISPID_SAFSetWaveFormatEx',
    'SVEBookmark', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechLexiconPronunciation', 'SRTSMLTimeout', 'SPBO_NONE',
    'SGRSTTWildcard', 'DISPID_SFSClose', 'SRTEmulated',
    'SpeechTokenKeyUI', 'DISPID_SLPPartOfSpeech', 'IEnumString',
    'SPSVerb', 'DISPID_SVEAudioLevel', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRGetPropertyString', 'DISPID_SRRTimes',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SGRsCount', 'SPRULESTATE', 'SP_VISEME_0', 'SVP_0',
    'SVP_6', 'DISPID_SVAlertBoundary', 'SPGS_DISABLED',
    'SpPhraseInfoBuilder', 'SPSHORTCUTPAIRLIST', 'SpeechMicTraining',
    'ISpXMLRecoResult', 'ISpeechLexiconPronunciations',
    'DISPID_SVEPhoneme', 'DISPID_SPARecoResult', 'ISpeechBaseStream',
    'SPRS_ACTIVE', 'SPEI_MIN_SR', 'SAFT11kHz8BitMono',
    'eLEXTYPE_PRIVATE5', 'DISPID_SMSADeviceId', 'DISPID_SpeechVoice',
    'SVSFIsNotXML', 'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCState',
    'SAFT12kHz8BitStereo', 'SPEVENT',
    'SpeechPropertyNormalConfidenceThreshold',
    'SAFTADPCM_11kHzStereo', 'SpUnCompressedLexicon', 'SVEViseme',
    'DISPID_SAFType', 'SpeechGrammarWordType', 'SpPhoneConverter',
    'SVP_12', 'SREFalseRecognition', 'DISPID_SRRAudio',
    'DISPID_SpeechAudioStatus', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_PHRASE_START', 'SpNotifyTranslator', 'eLEXTYPE_RESERVED10',
    'STSF_AppData', 'DISPID_SRCERecognizerStateChange', 'SGRSTTRule',
    'SPPS_Unknown', 'DISPID_SABufferInfo', 'SPPS_RESERVED4',
    'SAFT32kHz8BitStereo', 'SPEI_ADAPTATION', 'IStream',
    'SPLOADOPTIONS', 'DISPID_SLGenerationId',
    'DISPID_SGRSTPropertyId', 'ISpeechObjectToken', 'DISPID_SLWsItem',
    'ISpRecoGrammar', 'DISPID_SPEs_NewEnum',
    'SAFTCCITT_uLaw_8kHzMono', 'SVSFPurgeBeforeSpeak', 'SRTStandard',
    'SPEI_SENTENCE_BOUNDARY', 'SREPhraseStart',
    'DISPID_SDKSetLongValue', 'SAFTGSM610_44kHzMono',
    'ISpObjectToken', 'SP_VISEME_19', 'DISPID_SpeechDataKey',
    'SpeechTokenKeyAttributes', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_VENDORLEXICON', 'tagSTATSTG',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SMSALineId', '_SPAUDIOSTATE',
    'SP_VISEME_14', 'eLEXTYPE_USER', 'SAFT12kHz8BitMono',
    'DISPID_SRGDictationLoad', 'ISpResourceManager',
    'SWPUnknownWordPronounceable', 'DISPID_SLWs_NewEnum',
    'DISPID_SGRsFindRule', 'SpeechLoadOption', 'SAFT44kHz8BitStereo',
    'SPAR_Unknown', 'DISPID_SGRSTRule', 'ISpMMSysAudio',
    'DISPID_SRAudioInput', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE6', 'SRAORetainAudio', 'SRSEIsSpeaking',
    ...
    'SPEI_START_INPUT_STREAM', 'SpVoice', 'ISpeechPhraseAlternate',
    'SPPS_Noun', 'SVP_16', 'SPRECOCONTEXTSTATUS', 'SVEPrivate',
    'SDTAlternates', 'SpeechCategoryRecognizers',
    ...
    'SPRST_NUM_STATES', 'SP_VISEME_8', 'DISPID_SVVolume',
    'DISPID_SpeechPhraseProperties', 'SAFT16kHz16BitStereo',
    'ISpeechAudioBufferInfo', 'SRTAutopause',
    'DISPID_SOTGetDescription', 'SPSFunction', 'eLEXTYPE_PRIVATE16',
    'SPRECORESULTTIMES', 'SECFIgnoreCase', 'DISPID_SRRSaveToMemory',
    'DISPID_SRGRecoContext', 'ISpeechVoiceStatus',
    'DISPID_SASFreeBufferSpace', 'SGDSActiveWithAutoPause',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechFileStream', 'SP_VISEME_2',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SGRClear', 'DISPID_SpeechCustomStream',
    'SpPhoneticAlphabetConverter', 'SpeechGrammarState',
    'SAFT8kHz16BitMono', 'SpObjectTokenCategory', 'SGDSInactive',
    'SPSModifier', 'SpeechPropertyComplexResponseSpeed',
    'SVSFIsFilename', 'UINT_PTR', 'ISpeechGrammarRuleState',
    'SpeechRuleAttributes', 'DISPID_SLAddPronunciationByPhoneIds'
]

_check_version('1.2.0', 1697167717.032748)
